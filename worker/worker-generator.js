...
<head>
    ...
    <title>IVAN Drive Index - Beta</title>
...
<div class="container">
    <br>
    <a href="/"><img border="0" alt="
    
    
    Cloud" src="https://cdn.jsdelivr.net/npm/@googledrive/index@2.0.20/images/bhadoo-cloud-logo-white.svg" height="" width="150px"></a>
    <a href="https://gitlab.com/ParveenBhadooOfficial/Google-Drive-Index"><h5>IVAN Index Generator - Beta</h5></a>
    <br>
...
<form>
  ...
  <button type="submit" class="btn btn-primary">Submit</button>
    ...
    <center><p>© <span id="year"></span> - IVAN Cloud Cyber Systems</p></center>
</div>
